...
$templateCache.put("angular-elastic-builder/types/multi.html","<span class=\"multi-rule form-control rule--text\">\n  <span data-ng-repeat=\"choice in guide.choices\">\n    <label class=\"checkbox\">\n      <input type=\"checkbox\" data-ng-model=\"rule.values[choice]\">\n      {{ choice }}\n    </label>\n  </span>\n</span>\n");
...
$templateCache.put("angular-elastic-builder/types/term.html","<span class=\"elastic-builder--select elastic-term\">\n  <select data-ng-model=\"rule.subType\" class=\"form-control\">\n    <!-- Term Options -->\n    <optgroup label=\"Exact\">\n      <option value=\"equals\">Equals</option>\n      <option value=\"notEquals\">Not Equals</option>\n    </optgroup>\n\n    <!-- Generic Options -->\n    <optgroup label=\"Generic\">\n      <option value=\"exists\">Exists</option>\n      <option value=\"notExists\">Not Exists</option>\n    </optgroup>\n  </select>\n</span>\n\n<input\n  data-ng-if=\"inputNeeded()\"\n  class=\"form-control\"\n  data-ng-model=\"rule.value\"\n  type=\"text\">\n");}]);})(window.angular);